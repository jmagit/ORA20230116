...
DECLARE
    ...
    v_count number := 0;
    v_procedure VARCHAR(100) := 'remove'; --add, change, remove
    v_stmt VARCHAR2(500);
...
EXCEPTION
    when MESSAGES_PKG.insert_null_exception OR MESSAGES_PKG.update_null_exception then
